...
//Texture Global
int fRestaurant, bRestaurant, lRestaurant, rRestaurant, roofRestaurant, floorRestaurant, OuterRestaurant, RestaurantLogo;
int fOuterMall, lOuterMall, rOuterMall, bOuterMall, wallInMall, floorInMall, roofInMall, upDoorMall, stairsFront, stairsDown, stairsLeft;
int RestaurantWall, RestaurantBackWall, BurgerKingUp, BurgerKingDown, MuslimUp, MuslimDown, AlBaikUp, AlBaikDown;
int outerCoffee, innerCoffeeWall, innerCoffeeRoof, innerCoffeeGround;
...
float eyeX = 0, eyeY = 2.5, eyeZ = 4, angel = -1.5, pitch = 0;
...
int InitGL(GLvoid)										// All Setup For OpenGL Goes Here
{
	...
	//Restaurant
	RestaurantWall = LoadTexture("Gallery\\Resturants\\ResturantWall.bmp");
	RestaurantBackWall = LoadTexture("Gallery\\Resturants\\BackWall.bmp");
	OuterRestaurant = LoadTexture("Gallery\\Resturants\\OuterRestaurant.bmp");
	RestaurantLogo = LoadTexture("Gallery\\Resturants\\RestaurantLogo.bmp");

	//Coffee
	outerCoffee = LoadTexture("Gallery\\Resturants\\ResturantWall.bmp");
	innerCoffeeWall = LoadTexture("Gallery\\Coffee\\innerCoffeeWall.bmp");
	...
	PizzaHotLogo = LoadTexture("Gallery\\Resturants\\PizzaHot\\PizzaHot.bmp");
	PizzaHotUnderLogo = LoadTexture("Gallery\\Resturants\\PizzaHot\\PizzaHotUnderLogo.bmp");
	BurgerKingUp = LoadTexture("Gallery\\Resturants\\BurgerKing\\Up.bmp");
	BurgerKingDown = LoadTexture("Gallery\\Resturants\\BurgerKing\\Under.bmp");
	MuslimUp = LoadTexture("Gallery\\Resturants\\Muslim\\Up.bmp");
	MuslimDown = LoadTexture("Gallery\\Resturants\\Muslim\\Down.bmp");
	AlBaikUp = LoadTexture("Gallery\\Resturants\\AlBaik\\Up.bmp");
	AlBaikDown = LoadTexture("Gallery\\Resturants\\AlBaik\\\Down.bmp");
	Fence = LoadTexture("Gallery\\Resturants\\Fence.bmp", 255);
	tableTexture = LoadTexture("Gallery\\Table\\Table.bmp");
	tableLegsTexture = LoadTexture("Gallery\\Table\\TableLegs.bmp");

	//Restaurant Texture
	fRestaurant = LoadTexture("Gallery\\Restaurants\\restaurantWall.bmp", 255);
	bRestaurant = LoadTexture("Gallery\\SkyBox\\CyenWall.bmp", 255);
	lRestaurant = LoadTexture("Gallery\\SkyBox\\CyenWall.bmp", 255);
	rRestaurant = LoadTexture("Gallery\\SkyBox\\CyenWall.bmp", 255);
	roofRestaurant = LoadTexture("Gallery\\SkyBox\\floor.bmp", 255);
	floorRestaurant = LoadTexture("Gallery\\SkyBox\\floor.bmp", 255);

	//Mall Texture
	wallInMall = LoadTexture("Gallery\\Mall\\inWall.bmp");
	floorInMall = LoadTexture("Gallery\\Mall\\mallFloor.bmp");
	upDoorMall = LoadTexture("Gallery\\Mall\\upDoorWall.bmp");
	stairsDown = LoadTexture("Gallery\\Mall\\stairsDown.bmp");
	//Lighting
